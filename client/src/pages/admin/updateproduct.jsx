...
import { getadminprodbyIdthunk, updateproductthunk } from "../../components/redux/features/admin/adminproductSlice.js"
...
function Updateproduct() {
  ...
  const {loading,product}=useSelector((state)=>state.productoperation)
  const ref=useRef()
 ...
 useEffect(()=>{
    dispatch(getadminprodbyIdthunk(id))
 },[dispatch])
 ...
 useEffect(()=>{
    if(product){
        ...
        setseceltedcategory(product.category);
  ...
  form.append("image", formdata.image);
    ...
    try {
      ...
      //    form.append(key,formdata[key])
      // }
      const res = await dispatch(updateproductthunk({id:product?._id,formdata:form})).unwrap();
      const { message } = res;
